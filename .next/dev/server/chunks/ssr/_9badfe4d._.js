...
"[project]/app/rotinas/nova/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NovaRotinaPage() {
    ...
    const [routineExercises, setRoutineExercises] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    /** ============ CARREGAR EXERCÍCIOS ============ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function load() {
            setLoading(true);
            try {
                const ex = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$exercise$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["exercisesApi"].getAll();
                setExercises(ex);
            } finally{
                setLoading(false);
            }
    ...
    /** ============ SALVAR ROTINA ============ */ async function save() {
        ...
        setSaving(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$routines$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["routinesApi"].create({
                name: routineName,
...
//# sourceMappingURL=_9badfe4d._.js.map